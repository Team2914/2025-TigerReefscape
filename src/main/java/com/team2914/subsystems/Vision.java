...
public class Vision extends SubsystemBase {
  ...
  private Vision() {
    ...
    photonPoseEstimator =
        new PhotonPoseEstimator(fieldLayout, PoseStrategy.CLOSEST_TO_REFERENCE_POSE, robotToCamera);
  ...
  public boolean hasTargets() {
    return Robot.isSimulation()
        ? !frontCameraSim.getCamera().getLatestResult().getTargets().isEmpty()
        : !frontCamera.getLatestResult().getTargets().isEmpty();
  }
}
