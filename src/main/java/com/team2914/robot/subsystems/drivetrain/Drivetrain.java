...
import com.team2914.robot.subsystems.drivetrain.simulation.TigerAHRS;
...
// Taken from REV's MAXSwerve template
public class Drivetrain extends SubsystemBase {
    public static Drivetrain instance = null;

    private final boolean robotRelative = true;
    ...
    private TigerAHRS gyro = new TigerAHRS();
    ...
    public SwerveModule[] getSwerveModules(){
        return new SwerveModule[]{m_frontLeft, m_frontRight, m_rearLeft, m_rearRight};
    }
    ...
    public double getTurnRate() {
        return gyro.getRealGyro().getRate() * (DriveConstants.kGyroReversed ? -1.0 : 1.0);
    }
}
